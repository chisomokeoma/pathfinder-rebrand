...
export default function ArticleForm() {
  ...
  const { mutate, isLoading } = useMutation({
    mutationFn: (payload: IArticle) =>
      builder.use().resources.article.create(payload),
    onSuccess(data) {
  ...
  return (
    <form
      ...
      onSubmit={articleForm?.onSubmit(() =>
        // mutate(
        //     {
        //   ...articleForm?.values,
        //   lessons: Number(articleForm.values.lessons),
        // }
        // )
        mutate(articleForm.values)
      )}
    >
      <div className="flex flex-col gap-[30px]">
        ...
        <TextInput
          styles={styles}
          placeholder="Title"
          {...articleForm.getInputProps("title")}
        />
        ...
        <Select
          ...
          {...articleForm.getInputProps("category")}
        />

        <TextInput
          styles={styles}
          placeholder="content"
          {...articleForm.getInputProps("content")}
        />
        <TextInput
          styles={styles}
          placeholder="Course duration"
          {...articleForm.getInputProps("duration")}
        />
